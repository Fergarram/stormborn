...
function stormborn(config) {
	...
	function instances_collided(a, b) {
		if (!a || !b) return false;
	...
	function instance_collision(instance, obj_id) {
		const room = gm.rooms[gm.current_room];
		if (!instance) return;
...
var stormborn_default = { point_distance, point_direction, unique_id };
export { stormborn, stormborn_default as default };

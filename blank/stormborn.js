...
function create_game(config) {
  ...
  function is_visible_to_camera(instance, camera) {
    if (!instance.sprite && !instance.tile_layer)
      return true;
    ...
    return !(instance.x + width < camera.x || instance.x > camera.x + camera.width || instance.y + height < camera.y || instance.y > camera.y + camera.height);
  }
